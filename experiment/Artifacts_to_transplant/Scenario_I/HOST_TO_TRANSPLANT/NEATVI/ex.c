...
static int ec_write_archive(char *ec)
{
    ...
    //Descomente esta linha abaixo após transferir os arquivos da feature da pasta Temp/FEATURE para o diretório do host durante a etapa de inserção
    //write_archive_GRAFT_INTERFACE (ec, path, s);
