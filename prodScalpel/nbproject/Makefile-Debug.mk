...
# C Compiler Flags
CFLAGS=-std=gnu99 -Wall -g -O0 -DDEBUG
...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/gentrans: ${OBJECTFILES}
	...
	${LINK.c} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/gentrans ${OBJECTFILES} ${LDLIBSOPTIONS} -lpthread -lm -DDEBUG

${OBJECTDIR}/DeclarationSymbolTable.o: DeclarationSymbolTable.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DeclarationSymbolTable.o DeclarationSymbolTable.c

${OBJECTDIR}/DeclarationWithHeaderDefinition.o: DeclarationWithHeaderDefinition.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DeclarationWithHeaderDefinition.o DeclarationWithHeaderDefinition.c

${OBJECTDIR}/DependencyList.o: DependencyList.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DependencyList.o DependencyList.c

${OBJECTDIR}/DependencyListWithID.o: DependencyListWithID.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DependencyListWithID.o DependencyListWithID.c

${OBJECTDIR}/FeatureInterface.o: FeatureInterface.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FeatureInterface.o FeatureInterface.c

${OBJECTDIR}/FunctionCallDependency.o: FunctionCallDependency.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FunctionCallDependency.o FunctionCallDependency.c

${OBJECTDIR}/FunctionElement.o: FunctionElement.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FunctionElement.o FunctionElement.c

${OBJECTDIR}/GIReduction.o: GIReduction.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GIReduction.o GIReduction.c

${OBJECTDIR}/GP.o: GP.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GP.o GP.c

${OBJECTDIR}/GPIndividual.o: GPIndividual.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GPIndividual.o GPIndividual.c

${OBJECTDIR}/GlobalDeclarations.o: GlobalDeclarations.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GlobalDeclarations.o GlobalDeclarations.c

${OBJECTDIR}/IndividualInstantiator.o: IndividualInstantiator.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/IndividualInstantiator.o IndividualInstantiator.c

${OBJECTDIR}/ListOfFunctionSourceFile.o: ListOfFunctionSourceFile.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ListOfFunctionSourceFile.o ListOfFunctionSourceFile.c

${OBJECTDIR}/ListOfInt.o: ListOfInt.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ListOfInt.o ListOfInt.c

${OBJECTDIR}/ListOfString.o: ListOfString.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ListOfString.o ListOfString.c

${OBJECTDIR}/MappingCandidate.o: MappingCandidate.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MappingCandidate.o MappingCandidate.c

${OBJECTDIR}/Mappping.o: Mappping.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Mappping.o Mappping.c

${OBJECTDIR}/MarkFunctionCall.o: MarkFunctionCall.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MarkFunctionCall.o MarkFunctionCall.c

${OBJECTDIR}/OptionParser.o: OptionParser.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/OptionParser.o OptionParser.c

${OBJECTDIR}/PrepareForGP.o: PrepareForGP.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PrepareForGP.o PrepareForGP.c

${OBJECTDIR}/ReductionIndividual.o: ReductionIndividual.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ReductionIndividual.o ReductionIndividual.c

${OBJECTDIR}/Skeleton.o: Skeleton.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Skeleton.o Skeleton.c

${OBJECTDIR}/SkeletonMapping.o: SkeletonMapping.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SkeletonMapping.o SkeletonMapping.c
...
${OBJECTDIR}/coreFunctionExtractor.o: coreFunctionExtractor.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/coreFunctionExtractor.o coreFunctionExtractor.c

${OBJECTDIR}/folderContent.o: folderContent.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/folderContent.o folderContent.c
...
${OBJECTDIR}/reverseCallGraph.o: reverseCallGraph.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/reverseCallGraph.o reverseCallGraph.c
