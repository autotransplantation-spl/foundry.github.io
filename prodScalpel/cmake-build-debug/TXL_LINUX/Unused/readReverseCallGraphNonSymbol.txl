...
%char * donorSourceFiles, char * reversedCflowOutput, 
 %       char * modifiedFunctionLOCsOutput, char * SkeletonInstantiateMappings, char * HostSymbolTable, 
  %      char * CurrentExistingMappings
...
function main
	...
	deconstruct TXLargs
		donorSourceFiles [stringlit] reversedCflowOutput [stringlit] modifiedFunctionLOCsOutput [stringlit] 
		SkeletonInstantiateMappings [stringlit] HostSymbolTable [stringlit] CurrentExistingMappings [stringlit]
...
function constructNewGPFunctions
	...
	construct msss [repeat function_instante_mappings]
		MappingsForFunctionInstantiation [write "SkeletonInstantiateMappings.out"]
		
	construct ms2 [repeat symbol_table_entry]
		HostSymbolTable [write "HostSymbolTable.out"]
		
	construct ms3 [repeat symbol_mapping]
		CurrentMappings [write "CurrentExistingMappings.out"]
...
function rewriteAsLocs	FctDef [function_definition_or_declaration]
	...
	construct FunctionHeaderDeclStmMarker [declaration_or_statement_markers]
		FunctionHeaderStringlit
	%construct FunctionHeaderDeclStmMarkerRepeat [repeat declaration_or_statement_markers]
	%	_ [. ]
	construct blockStart [declaration_or_statement_markers]
		"{"
	construct blockEnd [declaration_or_statement_markers]
		"}"
		
	construct completeFunctionDefinition [repeat declaration_or_statement_markers]
		_ [. FunctionHeaderDeclStmMarker] [. blockStart] [. DeclAsStrings] [. blockEnd]
		
	construct DeclAsIds [repeat ids_with_line_break]
		_ [stringlitToId completeFunctionDefinition]	
...
function declToStringlit	Decl [repeat declaration_or_statement_markers]
	...
	construct firstSolvedCallFunctions [declaration_or_statement_markers]
		first  [solveCalledFunctionNoCompund first CurrentCalledFunction CurrentCalledRet ArgsSymbolTable]
...
function solveCalledFunctionNoCompund	OriginalStm [declaration_or_statement_markers]
										CurrentCalledFunction [stringlit]
										CurrentCalledRet [return_structure]
										ArgsSymbolTable [repeat declaration]
	...
	where not
		...
		construct msssss [declaration_or_statement_markers]
			OriginalStm [fput "DADADA.out"]
		
		construct newCurrent [declaration_or_statement_markers]	
			current [solveCalledFunction OriginalStm CurrentCalledFunction CurrentCalledRet ArgsSymbolTable]
...
function solveCalledFunction	OriginalStm [declaration_or_statement_markers]
	...
	construct replacedMacroSpecifier [declaration_or_statement]
		replacedUnaryExpr [replaceNeededFunctionCallMacroSpecifier CurrentCalledFunction CurrentCalledRet ArgsSymbolTable][fput "PULAAAAAA.out"]

	construct sepppp[stringlit]
		">>>>>>>>>>>>>>" 
		
	construct messs [stringlit]
		sepppp [fput "PULAAAAAA.out"]
...
rule replaceNeededFunctionCallMacroSpecifier	FunctionName [stringlit]
	...
	construct mes33sss [macro_arguments]
		...
		construct ListOfDeclarations [repeat declaration_or_statement_markers]
			_ [declarationArgsToStringlit ArgsSymbolTable macroAsRepeatStrings calledFctName uniqueFctStringlit] 
		...
		construct msTEMP [declaration_or_statement_markers]
			"printf(\"CALLPOINT\");"
...
function declarationArgsToStringlit	Declarations[repeat declaration]
	...
	export CurrentMappings
		CurrentMappings [. newMapping]	
		
		

	%construct SpecifiersStrings [repeat argument_symbol]
		%_ [declSpecToArgSymbol declSpec]
	...
	construct typeNameID [id]
		_ [quote typeNameString]
		
	construct varCompleteID [id]
		_ [quote varCompleteDeclStringlit]	
	...
	export HostSymbolTable
		HostSymbolTable [. newHostTableEntry]
	[fput "SYMBOLTABLE.outs"]
...
function declSpecToArgSymbol	DeclSpec [repeat decl_qualifier_or_type_specifier]
	replace [repeat argument_symbol]
		current [repeat argument_symbol]
...
rule replaceNeededFunctionCallArgs	FunctionName [stringlit]
	...
	where not
		...
		construct ListOfDeclarations [repeat declaration_or_statement_markers]
			_ [declarationArgsToStringlit ArgsSymbolTable ArgsAsRepeatStrings calledFctName uniqueFctStringlit] [fput "testDecl.out"]
		...
		construct fls [declaration_or_statement_markers]
			finalLabelString 
			
			
			
		construct labelDeclOrStmMarker [repeat declaration_or_statement_markers]
			_ [. fls]
		construct msTEMP [declaration_or_statement_markers]
			"printf(\"CALLPOINT\");"
		...
		export ReplacedToken
			_ [. ListOfDeclarations] [. callFctAsDeclStmMarker] [. exprAsDeclStmMarker]  [. msTEMP] [.testDeclMarker]
...
rule replaceNeededFunctionCallUnaryExpr	FunctionName [stringlit]
	...
	where not
		...
		construct ListOfDeclarations [repeat declaration_or_statement_markers]
			_ [declarationArgsToStringlit ArgsSymbolTable ArgsAsRepeatStrings calledFctName uniqueFctStringlit] 
...
function solveCompundStatement	CurrentStatement [declaration_or_statement_markers]
	...
	construct compundNoBody [declaration_or_statement_markers]
		...
		%%!!!!!!!!!!!!!!!!!!1!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
	construct firstSolvedCallFunctions [declaration_or_statement_markers]
		compundNoBody [solveCalledFunction compundNoBody FunctionName CurrentCalledRet ArgsSymbolTable] [fput "COMPUND.out"]
		
	
	construct checkthetype [declaration_or_statement_markers]
	 firstSolvedCallFunctions [ CheckAllTYPES]
