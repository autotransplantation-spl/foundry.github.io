...
function main
	...
	deconstruct P 
   	...
   	construct listOfAllDependencies [repeat dependency_output]
   		_ [dependenciesForAllFunctions interfaceFunctionsDefs]
...
function dependenciesForAllFunctions	P [repeat function_definition_or_declaration]
	...
	export ListOfAllDependencies [repeat dependency_output]
   		_
    construct createTheListOfStatements [function_definition_or_declaration]
   		first [fixEveryBlock first]		
   	import ListOfAllDependencies [repeat dependency_output]
	
	
	by
		current [. ListOfAllDependencies]
		[dependenciesForAllFunctions rest] 
end function
