...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%This program will add the identified interface to the IceBox Test Directory								 %	
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
function addTheGraftInFunction
    ...
    deconstruct body
   	...
   	construct  listWithoutReturn [repeat declaration_or_statement]
   		listFromBody  [insertNewGraftSign]
	by 
		listWithoutReturn
end function

function insertNewGraftSign
    replace * [addGraft]
		G [addGraft]
