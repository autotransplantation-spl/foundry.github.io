...
#define REG_NOAUTOQUOTE	0x0000080 /* no automatic quoting of REG_BADRPTs */
	...
	*/
#define REG_EXTENDED	(REG_OR | REG_PLUS | REG_QUEST | REG_BRACES | REG_PARENS | REG_ANCHORS | REG_NOBACKREF | REG_NOAUTOQUOTE)
...
#define REG_OLDERE	(REG_OR | REG_PLUS | REG_QUEST | REG_NOBRACES | REG_PARENS | REG_ANCHORS | REG_ODDRANGE | REG_NOBACKREF | REG_ADDITIVE | REG_NOAUTOQUOTE)
